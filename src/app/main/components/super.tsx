...
function SuperSection() {
  return (
    <div className="md:px-7 px-2 mt-6">
      <Accordion
        className="flex w-full flex-col max-w-6xl mx-auto"
        ...
        <AccordionItem value="getting-started" className="py-2">
          ...
          <AccordionContent className="origin-left">
            <p className="pl-6 pr-2 text-zinc-500 dark:text-zinc-400">
              ...
              animations to your projects. You’ll get familiar with the initial
              setup and the core features quickly.
            </p>
          </AccordionContent>
        </AccordionItem>
